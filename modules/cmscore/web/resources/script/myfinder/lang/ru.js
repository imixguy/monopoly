 ...
 * ImixFinder
 * ========
 * http://imix.by/imixfinder
 * Copyright (C) 2013-2013, ImixSource - Mikhail Kachanouskii. All rights reserved.
 *
 * The software, this file, and its contents are subject to the imixFinder
 * License. Please read the license.txt file before using, installing, copying,
 * modifying, or distributing this file or part of its contents. The contents of
 * this file is part of the Source Code of imixFinder.
 *
 */

/**
 * @fileOverview Defines the {@link imixFinder.lang} object for the Russian
 *		language.
 */
...
ImixFinder.lang['ru'] =
{
	...
	500 : 'Браузер файлов отключен из-за соображений безопасности. Пожалуйста, сообщите вашему системному администратру и проверьте конфигурационный файл ImixFinder.',
