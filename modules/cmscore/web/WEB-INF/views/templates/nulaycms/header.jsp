...
<div style="height:20px;"></div><div style="height:120px; background:url("/resources/images/222.png");"></div><div style="height:5px;"></div>
<div style="height:20px;background:url("/resources/images/222.png");"></div>
