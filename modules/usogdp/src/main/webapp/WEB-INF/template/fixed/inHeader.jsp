...
<link href="${ctx}/resources/css/fixedtemplate.css" rel="stylesheet" title="maincss">

<%--<link rel="stylesheet" type="text/css" href="<c:url value="<%=Const.JQUERY_UI_CSS%>"/>"/>--%>
<link rel="stylesheet" type="text/css" href="<c:url value="<%=Const.JQUERY_UI_VIDGET_CSS%>"/>"/>
