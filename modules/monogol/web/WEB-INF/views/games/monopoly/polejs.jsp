...
//        this.migEl.attr('src','/resources/images/games/'+this.room.imageFolder+'/ramka.gif');
    ...
    buildPlace:function(listCardObj,size){
        ...
        centerLine.append('<div id="centerPl" class="centerPlace" style="position:relative;width:'+size.shCPl+'px;height:'+size.shCPl+'px;display: inline; float: left;"><img src="/resources/images/games/'+this.room.imageFolder+'/'+this.room.imageCenter+'" width="'+size.shCPl+'px" height="'+size.shCPl+'px"/></div>');
...
//                alert(datas);
        ...
        this.keyLoad=0;
        $.ajax({
            url: "/games/monopoly/actions/"+actions.toLowerCase(),
            dataType : datat,
            data:datas,
